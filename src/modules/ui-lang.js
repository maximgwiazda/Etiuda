...
UI_STRINGS.pl={
  ...
  "Type the name customers should see, exactly as you want it to appear; <span class=\"fillmiss\">AGENT</span> reproduces it verbatim. Internal comments sign with your initials as /<span class=\"fillmiss\">INIT</span>.":"Wpisz imię, które mają widzieć klienci, dokładnie w takiej formie, w jakiej ma się pojawiać; <span class=\"fillmiss\">AGENT</span> wstawia je bez zmian. Komentarze wewnętrzne są podpisywane inicjałami jako /<span class=\"fillmiss\">INIT</span>.",
  ...
  "Switch the language of macro text on screen; {KEY} flips it from anywhere. Intent clauses that come from the list follow <b class=\"t-acc\">EN</b>/<b class=\"t-pl\">PL</b>; free-typed intent text does not. A card with no Polish shows its English rather than a gap, so only the first language is ever required.":"Przełącz język treści makr na ekranie - {KEY} zmienia go z dowolnego miejsca. Frazy intencji wybrane z listy podążają za <b class=\"t-acc\">EN</b>/<b class=\"t-pl\">PL</b>; intencja wpisana ręcznie nie. Karta bez polskiej wersji pokazuje angielską zamiast luki, więc wymagany jest tylko pierwszy język.",
  "Fees, deadlines, and useful links - click a link-like token to copy the full URL. You can edit this text for yourself; it stays in this browser.":"Opłaty, terminy i przydatne odnośniki - kliknij element wyglądający jak odnośnik, aby skopiować pełny adres. Ten tekst można zmienić na własny użytek; zostaje w tej przeglądarce.",
  "Fees, deadlines, and useful links - click a link-like token to copy the full URL. You can edit this text for yourself; it stays on this computer.":"Opłaty, terminy i przydatne odnośniki - kliknij element wyglądający jak odnośnik, aby skopiować pełny adres. Ten tekst można zmienić na własny użytek; zostaje na tym komputerze.",
  "Etiuda follows your system's setting, and keeps following it. Clicking here is what turns that into a choice, and it is remembered from then on.":"Etiuda podąża za ustawieniem systemu i robi to nadal. Dopiero kliknięcie tutaj zamienia to w wybór, który od tej pory jest zapamiętany.",
  ...
  "Dark":"Ciemny",
  "System":"Systemowy",
  "System follows your computer's own setting.":"Systemowy podąża za ustawieniem tego komputera.",
  "Blur effects":"Efekty rozmycia",
