...
UI_STRINGS.pl={
  ...
  "Etiuda offers you the newest catalog from {FOLDER}; a catalog kept anywhere else comes in through Import above.":"Etiuda proponuje najnowszy katalog z {FOLDER}; katalog trzymany gdzie indziej trafia tu przez Importuj powyżej.",
  "Catalogs":"Katalogi",
  "Loaded":"Wczytany",
  "Newer":"Nowszy",
  ...
  "Forget every personal card, edit, hide, rename and layout choice on this computer; the loaded catalog stays. It is also how you bring back anything you deleted.":"Zapomnij wszystkie własne karty, zmiany, ukrycia, zmiany nazw i ustawienia układu na tym komputerze; wczytany katalog zostaje. Tak też przywracasz to, co usunięte.",
