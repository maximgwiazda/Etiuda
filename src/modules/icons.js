...
const CAT_IC_NUDGE={"notehead":[1.44,0.05],"beam":[0.39,-0.2],"flat":[-0.1,0],"fermata":[0,-0.88],"fork":[-0.39,0],"bubble":[0,-0.39],"split":[0,-1.18],"undo":[0.1,-0.39],"external":[-0.39,0.39],"doc":[-0.39,0],"bag":[0.01,0.39],"person":[0,-0.2],"access":[-0.59,0.39],"heart":[0,-0.22],"note":[0,0.39],"paw":[0,-0.45],"gift":[0,-0.45],"car":[0,-0.85],"pencil":[-0.21,0.26],"truck":[0,-0.59],"broken":[0,1.17],"brush":[-0.19,0.35],"cup":[-0.42,0.6]};
...
const CAT_ICONS={
  ...
  parcel:'<path d="M10 2.96L16.65 6.48V13.52L10 17.04L3.35 13.52V6.48Z"/><path d="M3.35 6.48L10 10L16.65 6.48"/><path d="M10 10V17.04"/><path d="M6.68 4.72L13.32 8.24"/>',
  truck:'<path d="M2.57 5.31H11.56V13.52H2.57Z"/><path d="M11.56 8.05H14.69L17.43 10.78V13.52H11.56"/><path d="M7.65 14.3A1.56 1.56 0 1 1 4.53 14.3A1.56 1.56 0 1 1 7.65 14.3Z"/><path d="M15.86 14.3A1.56 1.56 0 1 1 12.74 14.3A1.56 1.56 0 1 1 15.86 14.3Z"/>',
  broken:'<path d="M2.96 7.26H17.04A7.04 7.04 0 0 1 2.96 7.26Z"/><path d="M10 7.26L8.91 9.61L10.94 11.17L10 14.3"/><path d="M4.92 3.35L6.09 4.92"/><path d="M14.3 3.35L13.52 4.92"/>',
  receipt:'<path d="M5.31 2.57H14.69V17.43L13.13 16.41L11.56 17.43L10 16.41L8.44 17.43L6.87 16.41L5.31 17.43Z"/><path d="M7.65 6.48H12.35"/><path d="M7.65 9.22H12.35"/><path d="M7.65 11.95H10.78"/>',
  brush:'<path d="M16.65 3.35L10.39 9.61"/><path d="M10.63 9.84C8.67 8.91 6.64 9.84 6.32 11.8C6.09 13.36 5.23 14.54 3.74 15.63C6.79 16.57 10.16 15.4 10.94 12.81C11.17 12.03 11.41 11.02 11.41 10.63Z"/>',
  cup:'<path d="M4.14 7.26H13.91V10.78A4.89 4.89 0 0 1 4.14 10.78Z"/><path d="M13.91 8.44H15.08A1.76 1.76 0 0 1 15.08 11.95H13.91"/><path d="M7.26 3.35V4.92"/><path d="M10.78 3.35V4.92"/>'
};
