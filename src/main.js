/* The module tree's entry, and the app's first act.
   ...
   place does not. */
import * as bubble from "./modules/bubble.js";
...
import * as cardCarry from "./modules/card-carry.js";
...
Object.defineProperty(globalThis, "CAT_LABELS_BY_LANG", { get: () => icons.CAT_LABELS_BY_LANG });
...
function boot(){
  ...
  // What the pack names by a card the catalog no longer holds, before the first rebuild prunes it
  cardCarry.carryAtBoot();
